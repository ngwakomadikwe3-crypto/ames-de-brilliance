...
function AccountContent() {
  ...
  if (!c.ready) return <main className="ames-account"><div className="ames-account-panel ames-account-loading"><h1 className="ames-loading-title">Loading your AMES profile…</h1><p className="ames-loading-subtitle">Please wait a moment.</p></div></main>;
