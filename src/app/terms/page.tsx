export default function TermsPage() {
  return (
    <div className="px-4 md:px-6 py-8 max-w-2xl mx-auto w-full">
      <h2 className="text-[13px] font-bold mb-6">Terms of Use</h2>
      ...
      <div className="text-[11px] leading-relaxed space-y-4">
        ...
        <div>
          <h3 className="font-bold mb-1">2. Specifications and Certificates</h3>
          <p>Specifications, grades, weights, and images provided on this website are indicative only and are based on information provided by suppliers and grading laboratories. The final sale of any diamond is governed solely by the written sales contract and the stone&apos;s grading certificate as issued by the relevant grading laboratory (GIA, IGI, HRD, or other). No representation is made that any description or image on this site is accurate, complete, or current.</p>
        </div>
        ...
        <div>
          <h3 className="font-bold mb-1">5. No Payment Functionality</h3>
          <p>This website does not process payments of any kind. All financial transactions are conducted separately in accordance with the terms of the applicable written sales contract.</p>
        </div>

        <div>
          <h3 className="font-bold mb-1">6. Governing Law and Jurisdiction</h3>
          <p>These terms are governed by and construed in accordance with the laws of the Republic of Botswana. Any dispute arising out of or in connection with these terms or the use of this website shall be subject to the exclusive jurisdiction of the courts of the Republic of Botswana.</p>
        </div>
